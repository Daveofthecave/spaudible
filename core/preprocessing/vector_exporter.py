...
class VectorWriter:
    """Manages binary storage of vectors and index."""
    ...
    def __init__(self, output_dir="data/vectors"):
        ...
        # File paths
        self.vectors_path = self.output_dir / "track_vectors.b极"
    ...
    def write_vector(self, track_id: str, vector):
        """
        Write a single vector to the binary file.
        """
        ...
        try:
            ...
            # Create a default vector with all -1.0
            vector = [-1.0] * 32
            vector_bytes = struct.pack('32f', *vector)
    ...
    def write_metadata(self):
        ...
        metadata = {
            ...
            "description": "Vector cache: track embeddings; Vector index: track ID to offset mapping"            
        }
